...
const MealIngredientsDetailsComponent = () => {
      ...
      {mealDetails !== undefined && mealDetails.meals
            ...
            <div className='detail-container'>
                ...
                <div className="mealDetails">
                    ...
                    <Link to ="/mealbyingredients"><button className='cancel-btn'>Return to previous page</button></Link>
                </div>
            </div>
            )}
    </div>
...
export default MealIngredientsDetailsComponent;